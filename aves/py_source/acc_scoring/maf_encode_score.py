...
class MafEncodeScore:
    ...
    def process(self, out_file_path):
        ...
        #maf_file_path = '/paula/2018/acc_regions/scoring/data/acc_maf_ingroup/25/chr22/chr22_acc_25_35755921_35755946.maf'
        #maf_file_name = 'chr22_acc_25_35755921_35755946.maf'
